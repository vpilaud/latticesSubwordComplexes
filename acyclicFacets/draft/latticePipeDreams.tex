...
More precisely, the map which sends an elbow in row~$i$ and column~$j$ of the triangular shape to the diagonal~$[i,n+1-j]$ of the~$(n+2)$-gon provides the following correspondence: \\[.3cm]
\centerline{
...
elbow between pipes~$i$ and~$j$ of~$P$ & common side of triangles~$i\duality$ and~$j\duality$ of~$P\duality$, \\
cross between pipes~$i$ and~$j$ of~$P$ & common bisector between triangles~$i\duality$ and~$j\duality$ of~$P\duality$, \\
