...
The fact $i_1 \to i_2$ implies that $i_1$ has an elbow southwest of~$x$, while $i_2 \to i_1$ implies that $i_2$ has an elbow northeast of~$x$, so that $\omega$ is not dominant by \cref{lem:notDominant}.
