...
Before proving this theorem, we would like to make the following remarks about items~\eqref{item:convex} and~\eqref{item:cover}:
\begin{enumerate}
\setcounter{enumi}{0}
\item There are cases where $[e,\omega] \ne \linearExtensions(Q,\omega)$. Namely, some of the sets~$\linearExtensions(I)$ may not be included in~$[e,\omega]$, and may even not meet~$[e,\omega]$. See \cref{fig:counterExample1}.
%
%\begin{figure}[h]
...
\setcounter{enumi}{2}
\item Some of the sets~$\linearExtensions(I)$ may not be intervals. See \cref{fig:counterExample2}. Another example with~$\omega = \omega_\circ$ can be found in~\cite[Figure~9]{PilaudStump-brickPolytope}. 
%
\begin{figure}[p]
...
\end{figure}
\end{enumerate}
\cref{fig:counterExample1,fig:counterExample2} represent type~$A$ subword complexes.
