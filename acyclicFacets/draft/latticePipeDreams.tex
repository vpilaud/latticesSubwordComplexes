...
\begin{figure}[ht]
	...
	The restriction of the increasing flip poset on~$\pipeDreams(126543)$ to the set of acyclic facets~$\acyclicPipeDreams(126543)$ is not a lattice. But, the poset induced by increasing flips between acyclic facets in~$\acyclicPipeDreams(126543)$ is a lattice (\cref{thm:pipeDreamQuotient}).}
