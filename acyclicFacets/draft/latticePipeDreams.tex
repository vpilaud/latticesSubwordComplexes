...
The objective of this section is to partially extend the results about the lattice structure of acyclic pipe dreams, presented in \cref{sec:latticeAcyclicPipeDreams}, to the wider context of subword complexes in finite Coxeter groups.
...
Two facets $I,J \in \subwordFacets(Q,w)$ are said to be connected by a \defn{flip} if they differ one element:
