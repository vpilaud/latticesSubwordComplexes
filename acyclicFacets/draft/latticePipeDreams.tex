...
For the backward direction, assume we have a pipe dream $P$ that is not acyclic. The contact graph must contain a reduced cycle ${\bf C}=(i, j_1, \ldots, j_m)$ with $i<j_k$ for all $k \in [m]$. 
...
\centerline{\includegraphics[scale=.3]{TwoCasesofproof.pdf}}


For $c_1<a_m$, similarly to above,  we must now have $b_m<d_1$ and the pipe $j_m$ cannot have an elbow northwest of $(c_1,d_1)$.
